...
async function setup(){
    ...
    slut_cont.innerHTML = `<input type="checkbox" class="checkbox" id="partyTime" defaultChecked="${localStorage.getItem("slut.party")}"> Enable party time.<br><input type="text" value="${localStorage.getItem("slut.duration")}" class="form-control" id="cycleOverIn"> Set the time spent on each post in ms.`;
