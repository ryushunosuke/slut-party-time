...
function appendToTable(table, filelink, instorage) {
    ...
    table.append(tr);
    if (!instorage) localStorage.setItem("slut.imagelist", localStorage.getItem("slut.imagelist") + filelink + ",");
...
function setup() {
    ...
    document.getElementById("partyaddlast").onclick = function() {
        ...
        appendToTable(document.getElementById("slut.tablebody"), medialink, false);
    };

    if (localStorage.getItem("slut.imagelist") != "") {
        let images = localStorage.getItem("slut.imagelist");
        images = images.split(",");
        for (let i in images) {
            appendToTable(document.getElementById("slut.tablebody"), images[i], true);
        }
    }
    ...
    document.getElementById("slut.remember").onclick = function() {
        if (this.checked) {
            ...
            localStorage.setItem("slut.remember", medialink)
